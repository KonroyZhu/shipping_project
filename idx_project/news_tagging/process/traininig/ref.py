...
def load_data():
    ...
    with open("../../data/processed/data.pkl", 'rb') as f:
        data_x, data_y, word2id, tag2id, id2word, id2tag = pickle.load(f)
...
def main():
    ...
    with tf.variable_scope('embedding'):
        ...
        embedding = tf.Variable(tf.random_normal([vocab_size+1, FLAGS.embedding_size]), dtype=tf.float32)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--time_step', help='time steps', default=194, type=int)
    ...
    parser.add_argument('--checkpoint_dir', help='checkpoint dir', default='ckpt/softmax_model.ckpt', type=str)
